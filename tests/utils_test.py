...
def vacancies():
    return [
        ...
        Vacancy(
            title="Вакансия 4", url="https://example.com/vacancy4", salary="55000", description="Программист на Python"
        ),
    ]
...
def test_filter_vacancies(vacancies):
    ...
    assert all(
        "программист" in vac.description.lower() for vac in filtered_vacancies
    )  # Все вакансии должны содержать слово "программист"
